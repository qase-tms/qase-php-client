...
class SuitesApi
{
     ...
     * @param  string $code Code of project, where to search entities. (required)
     * @param  int $id Identifier. (required)
     * @param  \Qase\Client\Model\InlineObject1 $inlineObject1 inlineObject1 (required)
     *
     * @throws \Qase\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Qase\Client\Model\IdResponse
     */
    public function updateSuite($code, $id, $inlineObject1)
    {
        list($response) = $this->updateSuiteWithHttpInfo($code, $id, $inlineObject1);
        return $response;
    }
     ...
     * @param  string $code Code of project, where to search entities. (required)
     * @param  int $id Identifier. (required)
     * @param  \Qase\Client\Model\InlineObject1 $inlineObject1 (required)
     *
     * @throws \Qase\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Qase\Client\Model\IdResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateSuiteWithHttpInfo($code, $id, $inlineObject1)
    {
        $request = $this->updateSuiteRequest($code, $id, $inlineObject1);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateSuiteAsync($code, $id, $inlineObject1)
    {
        return $this->updateSuiteAsyncWithHttpInfo($code, $id, $inlineObject1)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateSuiteAsyncWithHttpInfo($code, $id, $inlineObject1)
    {
        $returnType = '\Qase\Client\Model\IdResponse';
        $request = $this->updateSuiteRequest($code, $id, $inlineObject1);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateSuiteRequest($code, $id, $inlineObject1)
    {
        // verify the required parameter 'code' is set
        if ($code === null || (is_array($code) && count($code) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if ($inlineObject1 === null || (is_array($inlineObject1) && count($inlineObject1) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $inlineObject1 when calling updateSuite'
            );
        }
