...
use Qase\Client\Model\CustomFieldCreate;
use Qase\Client\Model\CustomFieldResponse;
use Qase\Client\Model\CustomFieldsResponse;
use Qase\Client\Model\CustomFieldUpdate;
...
class CustomFieldsApi
{
     ...
     *
     * @param CustomFieldCreate $customFieldCreate customFieldCreate (required)
     *
     * @return IdResponse
    ...
    public function getCustomFieldsRequest($filters = null, $limit = 10, $offset = 0)
    {
        ...
        if ($limit !== null && $limit < 0) {
            throw new InvalidArgumentException('invalid value for "$limit" when calling CustomFieldsApi.getCustomFields, must be bigger than or equal to 0.');
        }
     ...
     *
     * @param int $id Identifier. (required)
     * @param CustomFieldUpdate $customFieldUpdate customFieldUpdate (required)
     *
     * @return Response
     * @throws InvalidArgumentException
     * @throws ApiException on non-2xx response
