...
class SearchApi
{
    ...
    public function searchRequest($query, $limit = 10, $offset = 0)
    {
        ...
        if ($limit !== null && $limit > 25) {
            throw new InvalidArgumentException('invalid value for "$limit" when calling SearchApi.search, must be smaller than or equal to 25.');
        }
        if ($limit !== null && $limit < 0) {
            throw new InvalidArgumentException('invalid value for "$limit" when calling SearchApi.search, must be bigger than or equal to 0.');
        }
